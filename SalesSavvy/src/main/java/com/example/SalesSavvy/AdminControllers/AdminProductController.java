...
import com.example.SalesSavvy.Adminservices.AdminProductService;
...
public class AdminProductController {
    ...
    public ResponseEntity<?> addProduct(@RequestBody Map<String, Object> productRequest){
        try {
            ...
            Product savedpProduct =adminProductService.addProductWithImage(name,description,price,stock,categoryId,imageUrl);
            return ResponseEntity.status(HttpStatus.CREATED).body(savedpProduct);
    ...
    public ResponseEntity<?> deletProduct(@RequestBody Map<String,Integer> requestBody){
        try {
